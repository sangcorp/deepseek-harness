...
describe('FishLogo', () => {
  it('renders the SangAI logo img', () => {
    const { container } = render(<primitives.FishLogo />)
    const img = container.querySelector('img')!
    expect(img.getAttribute('src')).toBe('/sangai-logo.jpg')
...
describe('BrandWordmark', () => {
  it('renders the SangAI Deepseek wordmark and logo', () => {
    const view = render(<primitives.BrandWordmark />)
    expect(view.container.textContent).toContain('SangAI Deepseek')
